...
<head>
    ...
    <div class="mobile_nav">
        ...
        <div class="mobile_nav_items">
            ...
            <a href="#"><i class="fa fa-user-plus" aria-hidden="true"></i><span class="ml-1">Transaksi</span></a>
    ...
    <div class="sidebar">
        ...
        <a href="<?= BASEURL; ?>/karyawan/index"><i class="fas fa-desktop"></i><span class="ml-1">Dashboard</span></a>
        <hr>
        <a href="<?= BASEURL; ?>/karyawan/profile"><i class="fa fa-user" aria-hidden="true"></i><span class="ml-1"> Profile</span></a>
        <a href="<?= BASEURL; ?>/karyawan/daftarKendaraan"><span class="material-icons">two_wheeler</span><span class="ml-1">Daftar kendaraan</span></a>
        <a href="<?= BASEURL; ?>/karyawan/transaksi"><i class="bi bi-cart-fill"></i><span class="ml-1">Transaksi</span></a>
        <a href="<?= BASEURL; ?>/karyawan/konsumen"><i class="bi bi-people-fill"></i><span class="ml-1">Daftar Konsumen</span></a>
