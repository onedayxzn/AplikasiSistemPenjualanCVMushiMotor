...
<head>
    ...
    <div class="mobile_nav">
        <div class="nav_bar">
            <img src="../public/img/18.jpg" class="mobile_profile_image" alt="">
        ...
        <div class="mobile_nav_items">
            ...
            <a href="#"><i class="fa fa-times" aria-hidden="true"></i><span class="ml-1">Log out</span></a>
    ...
    <div class="sidebar">
        ...
        <a href="<?= BASEURL; ?>/AdminGudang/index"><i class="fas fa-desktop"></i><span class="ml-1">Dashboard</span></a>
        <hr>
        <a href="<?= BASEURL; ?>/AdminGudang/profile"><i class="fa fa-user" aria-hidden="true"></i><span class="ml-1"> Profile</span></a>
        <a href="<?= BASEURL; ?>/AdminGudang/daftarkendaraan"><span class="material-icons">two_wheeler</span><span class="ml-1">Daftar kendaraan</span></a>
        <a href="<?= BASEURL; ?>/AdminGudang/kendaraanmasuk"><span class="material-icons">two_wheeler</span><span class="ml-1">kendaraan masuk</span></a>
        <a href="<?= BASEURL; ?>/AdminGudang/kendaraankeluar"><span class="material-icons">two_wheeler</span></i><span class="ml-1">kendaraan keluar</span></a>

        <a href="<?= BASEURL; ?>/AdminGudang/about"><i class="fa fa-question-circle" aria-hidden="true"></i><span class="ml-1">About</span></a>
