<div class="content">
    ...
    <div class="container mt-5">
        ...
        <hr>
        <div class="d-flex">
            <form action="<?= BASEURL; ?>karyawan/carikendaraan" method="POST" style="margin-left: auto;">
            ...
            <tbody>
                <?php foreach ($data['kendaraan'] as $knd) : ?>
                    <tr>
                        ...
                        <td class="text-center"><a href="<?= BASEURL; ?>/Karyawan/detailKendaraan/<?= $knd['Id_kendaraan']; ?>" class="badge badge-pill badge-primary">detail</a></td>
