...
<head>
    ...
    <div class="mobile_nav">
        ...
        <div class="mobile_nav_items">
            ...
            <a href="#"><i class="fa fa-user-plus" aria-hidden="true"></i><span class="ml-1">Input laporan</span></a>
    ...
    <div class="sidebar">
        ...
        <a href="<?= BASEURL; ?>/manajerkeuangan/index"><i class="fas fa-desktop"></i><span class="ml-1">Dashboard</span></a>
        <hr>
        <a href="<?= BASEURL; ?>/manajerkeuangan/profile"><i class="fa fa-user" aria-hidden="true"></i><span class="ml-1"> Profile</span></a>
        <a href="<?= BASEURL; ?>/manajerkeuangan/inputlaporan"><i class="fa fa-user-plus" aria-hidden="true"></i><span class="ml-1">Input laporan</span></a>
        <a href="<?= BASEURL; ?>/manajerkeuangan/daftarlaporan"><i class="fa fa-user-plus" aria-hidden="true"></i><span class="ml-1">Daftar laporan</span></a>
        <a href="#"><i class="fa fa-question-circle" aria-hidden="true"></i><span class="ml-1">About</span></a>
